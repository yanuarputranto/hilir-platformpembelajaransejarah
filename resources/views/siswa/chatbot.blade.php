...
<head>
    ...
    <style>
        ...
        .chatbot-header {
            background:rgb(0, 125, 193); /* Warna hijau untuk siswa */
            color: white;
            padding: 15px 20px;
            display: flex;
            align-items: center;
        ...
        /* ... (typing indicator dan responsive styles sama seperti versi guru) ... */
    </style>
</head>
...
<body class="host_version">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbars-host">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="{{ route('siswa.chatbot') }}">Chatbot AI</a></li>
                    </ul>
                    </ul>
                    <ul class="navbar-nav">
    <li>
    ...
    <script>
        // Script JavaScript sama persis dengan versi guru
