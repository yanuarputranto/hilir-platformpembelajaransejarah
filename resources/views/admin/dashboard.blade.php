...
<head>
    ...
    <title>Admin - Portal Pembelajaran Sejarah</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Aktivitas Pengguna</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
                                        <canvas id="aktivitasPenggunaChart"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Distribusi Materi</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-pie pt-4 pb-2">
                                        <canvas id="distribusiMateriChart"></canvas>
                                    </div>
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Sejarah Kuno
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Sejarah Modern
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Sejarah Lokal
                                        </span>
                                    </div>
                                </div>
                            </div>
